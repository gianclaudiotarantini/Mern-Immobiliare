        ...
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex gap-6 flex-wrap'>
            <div className='flex gap-2'>
              <input type='checkbox' id='vendita' className='w-5' onChange={handleChange}  checked={formData.type === 'vendita'}/>
              <span>Vendita</span>
            </div>
            <div className='flex gap-2'>
              <input type='checkbox' id='affitto' className='w-5'  onChange={handleChange} checked={formData.type === 'affitto'} />
              <span>Affitto</span>
            </div>
            <div className='flex gap-2'>
